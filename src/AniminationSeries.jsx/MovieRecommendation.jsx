...
const MovieRecommendation = () => {
  ...
  return (
    <div className="px-5 md:px-16 w-full relative bg-gray-800 py-8">
      <h2 className="py-3 text-[20px] md:text-[36px] text-white font-semibold">Movies Recommended For You</h2>
      ...
      >
        {movies.map((movie) => (
          <div
            key={movie.id}
            className="min-w-[300px] sm:w-[350px] md:w-[400px] lg:w-[450px] border-gray-600 rounded-lg hover:scale-110 transition-all duration-300 ease-in-out cursor-pointer"
          >
            <img
